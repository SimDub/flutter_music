...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new MyHomePage(title: 'Flutter Music'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Musique> maListeDeMusiques = [
    new Musique('Reset', 'Jaunter', 'assets/un.jpg', 'https://ia801309.us.archive.org/34/items/auboutdufil-archives/497/Jaunter-Reset.mp3'),
    new Musique('LSF 7th Gear Remix', 'SmallRadio', 'assets/deux.jpg', 'https://www.auboutdufil.com/audio/music_431.mp3'),
